...
namespace UTESA_STORE.RJForms
{
    public class ChildForm : BaseForm
    {
        ...
        private Color supernovaColor = UIAppearance.Style == UIStyle.Supernova ? Colors.GetSupernovaColor() : Color.CornflowerBlue;

        /// Controls  
        protected Panel pnlClientArea;
        private Panel pnlTitleBar;//Sets Form title bar
        private Label lblCaption;//Sets Form caption
        private CTDragControl dragControl;//Sets Form drag control (is component, the constructor accepts a parameter of type IContainer)
        private IconButton btnFormIcon;//Sets Form icon Button
        private CTDropdownMenu dmFormOptions;//Sets Dropdown menu of windows Form Options (is component, the constructor accepts a parameter of type IContainer)
        ...
        {//Apply theme settings
            ...
            {   //The form has the title bar and border
                ...
                {
                    pnlTitleBar.BackColor = Colors.DarkItemBackground;
        ...
        {//When the form enters activated mode (regains focus - form is redisplayed), 
            ...
            if (UIAppearance.Style == UIStyle.Supernova)
            {
                pnlTitleBar.BackColor = Colors.DarkItemBackground;//Set title bar backcolor    
