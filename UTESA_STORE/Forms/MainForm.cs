...
namespace UTESA_STORE.RJForms
{
    ...
    {
        /// This class inherits from the <see cref="BaseForm"/> class
        /// 
        ///<summary>
        ...
        internal CTDropdownMenu dmFormOptions;//Dropdown menu of Form Options (is component, the constructor accepts a parameter of type IContainer)

        private CTLabel lblCaption;//Form Caption
        ...
        private CTMenuIcon biSideMenuButton;//Side menu button
        private CTMenuIcon biFormIcon;//Form icon button
        ...
        private CTDragControl dragControl;//Form drag control, (is component, the constructor accepts a parameter of type IContainer)       
        ...
        public MainForm()
        {
            Colors.colorIndex = 0;//Reset superonva color index
            InitializeItems();
        ...
        {  ///Generic method with a Generic Delegate Parameter (Func <TResult>) and Menu Button Parameter where the data type is RJChildForm.
            ...
            if (senderMenuButton == null || senderMenuButton.GetType() != typeof(CTMenuButton))//Check if object is valid
            {
                RJMessageBox.Show("Please send valid object, null values ​​are not allowed");
                return;
            }
            CTMenuButton menuButton = (CTMenuButton)senderMenuButton;
            ChildForm form = Application.OpenForms.OfType<childForm>().FirstOrDefault();//Checks if the child form is already open
        ...
        {//Take form screenshot
            ...
            saveScreenshot.FileName = "UtesaStore #" + Path.GetRandomFileName();// Suggest a random name.
        ...
        {//Print Current Child Form
            ...
            var printForm = new PrintForm(bmpScreenshot, activeChildForm.Caption);//Open the print form and send the screenshot and the form title.
