...
namespace UTESA_STORE.RJForms.Private
{
    public partial class MessageForm : Form
    {
        ...
        public MessageForm(string text, string caption,
        ...
        {//load theme settings
            ...
            this.BackColor = Colors.DefaultFormBorderColor;//Set form border color
            

            if (UIAppearance.Theme == UITheme.Light)
            {
                this.pnlMessageText.BackColor = Colors.LightBackground;//Set BackgroundColor
                this.pnlIcon.BackColor = Colors.LightBackground;
                this.pnlButtons.BackColor = Colors.LightActiveBackground;//Set buttons panel backcolor
                this.lblMessageText.ForeColor = UIAppearance.TextColor;
            }
            else
            {
                this.pnlMessageText.BackColor = Colors.DarkBackground;//Set BackgroundColor
                this.pnlIcon.BackColor = Colors.DarkBackground;
                this.pnlButtons.BackColor =Utils.ColorEditor.Darken( Colors.DarkBackground,3);//Set buttons panel backcolor
        ...
        {//Create Cancel Button
            ...
            btnCancel.BackColor = Colors.Cancel;
        ...
        {//Create Yes Button
            ...
            btnYes.BackColor = Colors.Confirm;
        ...
        {//Create Abort Button
            ...
            btnAbort.BackColor = Colors.Delete;
        ...
        {//Create Ignore Button
            ...
            btnIgnore.BackColor = Colors.Cancel;
