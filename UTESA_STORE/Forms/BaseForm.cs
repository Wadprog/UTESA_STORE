...
namespace UTESA_STORE.RJForms
{
    public class BaseForm : Form
    {
        ...
        private bool isMaximized;//Get or sets if the form is maximized: Switch to stop code execution cycles in the resize event       
        ...
        public BaseForm()
        {
            ...
            miSnapLeft.IconColor = Colors.FantasyColorScheme1;
            ...
            miSnapRight.IconColor = Colors.FantasyColorScheme2;
            ...
            miExitSnap.IconColor = Colors.FantasyColorScheme3;
        ...
        private void ApplyAppearanceSettings()
        {
            ...
            {
                btnClose.FlatAppearance.MouseOverBackColor = Colors.FantasyColorScheme4;
                btnMaximize.FlatAppearance.MouseOverBackColor = Colors.FantasyColorScheme1;
                btnMinimize.FlatAppearance.MouseOverBackColor = Colors.Sky;
                if (isPrimaryForm)
                {
