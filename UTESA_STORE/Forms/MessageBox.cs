using UTESA_STORE.RJForms.Private;
...
namespace UTESA_STORE
{
    ...
    {
        /// <summary>
        /// In this abstract class, simply implement static methods to show the custom message box form (<see cref="MessageForm"/>)  and return a DialogResult.
        ...
        {//Displays a message box with specified text
            ...
            using (var msgForm = new MessageForm(text,//Set text message to display
        ...
        {//Displays a message box with specified text and caption.
            ...
            // Instantiate the RJMessageForm form using the USING statement to dispose of the form correctly when it has finished its purpose.
            using (var msgForm = new MessageForm(text, caption,//Set text message and caption to display
        ...
        {//Displays a message box with specified text, caption, and buttons
            ...
            // Instantiate the RJMessageForm form using the USING statement to dispose of the form correctly when it has finished its purpose.
            using (var msgForm = new MessageForm(text, caption, buttons,//Set text message, caption and buttons to display
        ...
        {//Displays a message box with specified text, caption, buttons, and icon
            ...
            // Instantiate the RJMessageForm form using the USING statement to dispose of the form correctly when it has finished its purpose.
            using (var msgForm = new MessageForm(text, caption, buttons, icon,//Set text message, caption, buttons and icon to display
        ...
        {//Displays a message box with the specified text, caption, buttons, icon, and default button.
            ...
            // Instantiate the RJMessageForm form using the USING statement to dispose of the form correctly when it has finished its purpose.
            using (var msgForm = new MessageForm(text, caption, buttons, icon, defaultButton))//Set text message, caption, buttons,icon and default button to display
            {
                result = msgForm.ShowDialog();//Show as modal form 
            }
            return result;//Return Dialog Result  
        ...
        {//Displays a message box in front of the specified object and with the specified text
            ...
            // Instantiate the RJMessageForm form using the USING statement to dispose of the form correctly when it has finished its purpose.
            using (var msgForm = new MessageForm(text,
        ...
        public static DialogResult Show(IWin32Window owner, string text, string caption)
        {
            ...
            using (var msgForm = new MessageForm(text, caption,
        ...
        public static DialogResult Show(IWin32Window owner, string text, string caption, MessageBoxButtons buttons)
        {
            ...
            using (var msgForm = new MessageForm(text, caption, buttons,
        ...
        public static DialogResult Show(IWin32Window owner, string text, string caption, MessageBoxButtons buttons, MessageBoxIcon icon)
        {
            ...
            using (var msgForm = new MessageForm(text, caption, buttons, icon,
        ...
        public static DialogResult Show(IWin32Window owner, string text, string caption, MessageBoxButtons buttons, MessageBoxIcon icon, MessageBoxDefaultButton defaultButton)
        {
            ...
            using (var msgForm = new MessageForm(text, caption, buttons, icon, defaultButton))
            {
                result = msgForm.ShowDialog(owner);
            }
            return result;
