...
namespace UTESA_STORE.RJControls
{
    public class CTDataGridView : DataGridView
    {
        ...
        private void InitializeItems()
        {
            ...
            this.BackgroundColor = Colors.LightItemBackground;
            ...
            RowStyle.BackColor = Colors.LightItemBackground;
        ...
        private void ApplyAppearanceSettings()
        {
            if (customizable == false)//if it is not customizable apply the theme
            {
                ...
                {
                    DgvBackColor = Colors.DarkItemBackground; //BackColor
                    RowsColor = Colors.DarkItemBackground;//Rows color 
                    ColumnHeaderColor = Colors.DarkActiveBackground;//Column headers color
                    ...
                    if (isAlternatingRowsColor)//if it is Alternate Rows Color, set a color for the alternate rows color
                    {
                        ...
                        AlternatingRowsColor = Utils.ColorEditor.Lighten(Colors.DarkActiveBackground, 5);//Alternate rows back color
                    ...
                    {
                        SelectionBackColor = Utils.ColorEditor.Lighten(Colors.DarkActiveBackground, 5);//Selection back color
                ...
                {
                    DgvBackColor = Colors.LightItemBackground;//BackColor
                    RowsColor = Colors.LightItemBackground;//Rows color   
