...
{
    public class CTDragControl : Component
    {
        /// <summary>
        ...
        public CTDragControl()
        {
            //Constructor without parameters  
        }
        public CTDragControl(IContainer container) //This constructor is invoked automatically in the form designer when the control is dragged from the toolbox onto the form.
        {
        ...
        public CTDragControl(Control _dragControl, Form _targetForm)
        {
        ...
        public CTDragControl(Control _dragControl, Form _targetForm, IContainer container)
        {   //Initializes a new instance and associates it with the specified container.
            //This constructor ensures that the object is removed correctly, since it is not a child of the form.
            container.Add((IComponent)this); 
