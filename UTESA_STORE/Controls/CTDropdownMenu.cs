...
{
    public class CTDropdownMenu : ContextMenuStrip
    {
        /// <summary>
        ...
        private bool ownerIsMenuButton; ///Sets or Gets if dropdown owns to main form side menu <see cref="CTMenuButton"/>
        ...
        public CTDropdownMenu(IContainer container)//This constructor is invoked automatically in the form designer when the control is dragged from the toolbox onto the form.
        ...
        private void ApplyAppearanceSettings()
        {
            ...
            foreach (ToolStripMenuItem menuItemL1 in this.Items)
            {
                ...
                if (UIAppearance.Theme == UITheme.Dark || this.OwnerIsMenuButton == true)//If the theme is dark  or the owner is menubutton set the text color of the dark style theme
                {
                    ...
                    if (!ActiveMenuItem) menuItemL1.ForeColor = Colors.DarkTextColor;
                }
                    ...
                    if (!ActiveMenuItem) menuItemL1.ForeColor = Colors.LightTextColor;
                ...
                foreach (ToolStripMenuItem menuItemL2 in menuItemL1.DropDownItems)
                {
                    ...
                    {
                        if (!ActiveMenuItem) menuItemL2.ForeColor = Colors.DarkTextColor;
                    }
                    else
                        if (!ActiveMenuItem) menuItemL2.ForeColor = Colors.LightTextColor;
                    ...
                    foreach (ToolStripMenuItem menuItemL3 in menuItemL2.DropDownItems)
                    {
                        ...
                        if (UIAppearance.Theme == UITheme.Dark || this.OwnerIsMenuButton == true)
                        {
                            if (!ActiveMenuItem) menuItemL3.ForeColor = Colors.DarkTextColor;
                        }
                        else
                            if (!ActiveMenuItem) menuItemL3.ForeColor = Colors.LightTextColor;
                        ...
                        foreach (ToolStripMenuItem menuItemL4 in menuItemL3.DropDownItems)
                        {
                            ...
                            if (UIAppearance.Theme == UITheme.Dark || this.OwnerIsMenuButton == true)
                            {
                                if (!ActiveMenuItem) menuItemL4.ForeColor = Colors.DarkTextColor;
                            }
                            else
                                if (!ActiveMenuItem) menuItemL4.ForeColor = Colors.LightTextColor;
