...
{
    public class CTMenuIcon : IconPictureBox
    {
        /// <summary>
        ...
        ///a drop down menu(<see cref = "CTDropdownMenu" />) of the properties of this control (<see cref="DropdownMenu"/>)
        ...
        //Control Fields
        private CTDropdownMenu dropdownMenu;//Sets and Gets dropdown menu
        #endregion
        ...
        {//Apply the setting when the HandleCreated event is activated
            ...
            if (UIAppearance.Style == UIStyle.Supernova)//if the style is supernova get a color
                supernovaColor = Colors.GetSupernovaColor();
        }
