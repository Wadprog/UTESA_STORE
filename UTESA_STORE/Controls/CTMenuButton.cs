...
{
    public class CTMenuButton : IconButton
    {
        /// <summary>
        ...
        /// to add a drop-down menu (<see cref="CTDropdownMenu"/>) from the properties(<see cref="DropdownMenu"/>)  
        ...
        /// until the form is closed<see cref="Activate(ChildForm)"/>
        /// -> As a drop-down menu button; allows associating many forms, the button and menu item is 
        /// activated/highlighted until all forms are closed <see cref="Activate(ChildForm, ToolStripMenuItem)"/>
        ...
        private Color supernovaColor = UIAppearance.Style == UIStyle.Supernova ? Colors.GetSupernovaColor() : Color.CornflowerBlue;//Sets and Gets supernova color if the style is supernova

        //Control Fields
        private CTDropdownMenu dropdownMenu;//Sets or Gets dropdown menu
        ...
        [Category("RJ Code Advance")]///create a new property to associate a <see cref="CTDropdownMenu"/>
        [Description("Gets or sets the RJDropdownMenu associated with this control")]
        public CTDropdownMenu DropdownMenu
        {
            get
            {
        ...
        { //Activate / highlight MenuItem
            ...
            if (UIAppearance.Style == UIStyle.Supernova)
                iconColor = Colors.GetSupernovaColor();
        ...
        {
            ///see predecessor method<see cref="Activate(ChildForm guestForm)"/>
        ...
        {
            ///see predecessor method<see cref="Activate(ChildForm guestForm, ToolStripMenuItem menuItem))"/>
        ...
        private void DropdownMenu_VisibleChanged(object sender, EventArgs e)
        {
            ...
            if (!DesignMode)//Run this when not in design mode
            {
                if (dropdownMenu.Visible)//If the dropdown menu was displayed
                {
                    ...
                    this.BackColor = Colors.SideMenuColor;//Restore back color
